...
cd .\..\tests\
dotnet test --no-build /p:Version=1.0.0 /p:CollectCoverage=true /p:CoverletOutputFormat=opencover /p:CoverletOutput=MyTestResults/ --logger "trx;logfilename=TestResults.trx" --results-directory="MyTestResults"
